...
function OpenRoleCard({
  ...
  return (
    <motion.a
      ...
      viewport={disableAnimation ? undefined : { once: true }}
      className="group relative overflow-hidden rounded-2xl border border-zinc-200 bg-white/70 p-5 backdrop-blur-[2px] transition-[border-color,box-shadow,background-color] duration-300 hover:border-zinc-300 hover:bg-white hover:shadow-[0_14px_32px_-28px_rgba(0,0,0,0.65)]"
    >
